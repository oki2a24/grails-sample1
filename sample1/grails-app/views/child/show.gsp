...
<html>
    ...
    <body>
        ...
        <div id="show-child" class="content scaffold-show" role="main">
            ...
            <f:display bean="child" />
            <g:form resource="${this.child}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.child}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
