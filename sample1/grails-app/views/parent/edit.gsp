...
<html>
    ...
    <body>
        ...
        <div id="edit-parent" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.parent}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.parent}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.parent}" method="PUT">
                <g:hiddenField name="version" value="${this.parent?.version}" />
                <fieldset class="form">
                    <f:all bean="parent"/>
                </fieldset>
