...
<html>
    ...
    <body>
        ...
        <div id="show-parent" class="content scaffold-show" role="main">
            ...
            <f:display bean="parent" />
            <g:form resource="${this.parent}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.parent}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
